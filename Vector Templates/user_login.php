...
<head>
		...
		<title>Login Page | Index - Null Design</title>
	...
	<style>
		...
		.formu  input[type='email'], form input[type="text"], form input[type="number"], form input[type="url"], form input[type="search"], form input[type="password"] {
		  display: block;
		  margin: 0;
		  padding: 0 1em 0;
		...
		.formu  input[type='email']:focus, form input[type="text"]:focus, form input[type="number"]:focus, form input[type="url"]:focus, form input[type="search"]:focus, form input[type="password"]:focus {
		  outline: none;
		...
		.formu  a:hover, form a:active {
		  background-color: #217093;
		}
		.formu  .inputGroup1 .helper {
		  position: absolute;
		  z-index: 1;
		  font-family: inherit;
		}
		.formu  .inputGroup1 .helper1 {
		  top: 0;
		  left: 0;
		...
		.formu  .inputGroup1.focusWithText .helper {
		  -webkit-transform: translate(1em, 1.55em) scale(0.6);
				  transform: translate(1em, 1.55em) scale(0.6);
		  opacity: 1;
		}
		.formu  .inputGroup2 input[type="password"] {
		  padding: .4em 1em .5em;
		}
		.formu  .inputGroup2 input[type="text"] {
		  padding: .025em 1em 0;
		}
		.formu  .inputGroup2 #showPasswordToggle {
		  display: block;
		...
		.formu  .inputGroup2 #showPasswordToggle input {
		  position: absolute;
		  z-index: -1;
		  opacity: 0;
		}
		.formu  .inputGroup2 #showPasswordToggle .indicator {
		  position: absolute;
		  top: 0;
		  left: 0;
		  height: .85em;
		...
		.formu  .inputGroup2 #showPasswordToggle .indicator:after {
		  content: "";
		  position: absolute;
		  left: .25em;
		  top: .025em;
		...
		.formu  .inputGroup2 #showPasswordToggle input:checked ~ .indicator:after {
		  visibility: visible;
		}
		.formu  .inputGroup2 #showPasswordToggle input:focus ~ .indicator, form .inputGroup2 #showPasswordToggle input:hover ~ .indicator {
		  border-color: #4eb8dd;
		}
		.formu  .inputGroup2 #showPasswordToggle input:disabled ~ .indicator {
		  opacity: .5;
		}
		.formu  .inputGroup2 #showPasswordToggle input:disabled ~ .indicator:after {
		  visibility: hidden;
		}
			</style>
		<script>
								...
								<div class="dropdown-menu">
									<ul>
										<li class="dropdown-submenu">
											<a href="category.php" title="Product List">Wallpaper</a>
											<div class="dropdown-menu level2">
												<ul>
													<li><a href="templates.php">Desktop Wallpaper</a></li>
													<li><a href="templates.php">Facebook Wallpaper</a></li>
													<li><a href="templates.php">Some Wallpaper</a></li>
										...
										<li class="dropdown-submenu">
											<a href="category.php" title="Product List">Vector</a>
											<div class="dropdown-menu level2">
												<ul>
										...
										<li class="dropdown-submenu">
											<a href="category.php" title="Product List">Logo</a>
											<div class="dropdown-menu level2">
												<ul>
													<li><a href="templates.php">Logo Logoan</a></li>
													<li><a href="templates.php">Logo Usaha</a></li>
						...
						<div class="login-form form">
								...
								<form class="formu" action="" method="POST" enctype="multipart/form-data">
									...
									<div class="inputGroup inputGroup3">
										<a href="login_proc.php" id="login">Log in</a>
									</div>	
								</form>
								<br>
								<br>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="block newsletter">
										...
										<div class="block-content">
											...
											<input type="text" placeholder="l" style="background:white;" value="www.youtube.com/?" readonly="true">
