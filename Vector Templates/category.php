...
<head>
        ...
        <?php $some_qr = mysqli_query($con , "SELECT * FROM kategori where id_kat ='$id'");?>
        <?php $ss_soc = mysqli_fetch_assoc($some_qr);?>
		<title><?php echo $ss_soc['nama_kategori'];?> | All - Null Design</title>
	...
	<body class="home home-1">
		<div id="all">
								...
								<div class="topbar-right d-flex justify-content-end">
									...
									<div class="dropdown account">
										...
										<div class="dropdown-menu">									
											...
											<div class="item">
												<a href="login_page.php" title="Log in to your customer account"><i class="fas fa-sign-in-alt"></i>Login</a>
											</div>
											<div class="item">
									...
									<div class="dropdown currency">
										...
										<div class="dropdown-menu">
                                            ...
                                            <?php $some_query = mysqli_query($con , "SELECT * FROM kategori");?>
                                            <?php while($f_result = mysqli_fetch_assoc($some_query)){ ?>
											<div class="item">
											<?php echo "<a style='text-transform:capitalize;' href='category.php?c=".$f_result['id_kat']."'>".$f_result['nama_kategori']."</a>" ?>
											</div>
                                            <?php } ?>
										</div>
									</div>	
						...
						<li class="dropdown">
                            ...
                            <ul>
									...
									<li class="dropdown-submenu">
										...
										<div class="dropdown-menu level2">
											<ul>
												<li><a href="" title="Product Detail - Left Sidebar">Logo Logoan</a></li>
												<li><a href="" title="Product List - Full Width 1">Logo Usaha</a></li>
			...
			<div id="content" class="site-content">
				...
				<div id="breadcrumb">
					<div class="container">
						<h2 class="title"><?php echo $ss_soc['nama_kategori'];?></h2>
								...
								<div class="products-bar">
									<div class="row">
										<div class="col-md-6 col-xs-6">
                                            ...
                                            <?php $f_query = mysqli_query($con, "SELECT count(*) as total FROM kategori,sub_kategori,template where kategori.id_kat = sub_kategori.id_kat and sub_kategori.id_sub = template.id_sub and kategori.id_kat = '$id'"); ?>
									...
									<div class="tab-pane" id="products-list">
										<div class="products-block layout-5">
                                            <?php $w_query = mysqli_query($con , "SELECT * FROM kategori,sub_kategori,template where kategori.id_kat = sub_kategori.id_kat and sub_kategori.id_sub = template.id_sub and kategori.id_kat = '$id'"); ?>
												...
												<div class="row">
													...
													<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
														<div class="product-info">
															...
															<?php echo	'<a class="add-to-cart" href="checkout.php?c='.urlencode($w_assoc['id_tempt']).'&k='.urlencode($w_assoc['id_kat']).'&s='.urlencode($w_assoc['id_sub']).'">
															...
															<?php echo 	'<a class="quickview" href="checkout.php?c='.urlencode($w_assoc['id_tempt']).'&k='.urlencode($w_assoc['id_kat']).'&s='.urlencode($w_assoc['id_sub']).'">
